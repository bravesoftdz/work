...
-- Meses
SELECT @Month = CONVERT(int, SrvValue) FROM Param WHERE IDParam = 77
--Percentual de A
SELECT @ClassA = CONVERT(int, SrvValue) FROM Param WHERE IDParam = 78
--Percentual de B
SELECT @ClassB = CONVERT(int, SrvValue) FROM Param WHERE IDParam = 79
