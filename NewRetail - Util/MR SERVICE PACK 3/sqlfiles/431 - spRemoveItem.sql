...
/* -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	TABELA DE ERROS PARA RETURN_VALUE
		...
		-207  Erro em deletar Sal_ItemRepair
	...
	18 Aug 2004		Rodrigo Costa		Gravar error log
	22 Mar	2006		Rodrigo Costa		Deletar Account Number
	03 Apr	2006		Rodrigo Costa		Deletar Item Repair
    -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  */
...
FROM
	Sal_ItemRepair IR
WHERE
	IR.IDPreInventoryMov =  @PreInventMovID
