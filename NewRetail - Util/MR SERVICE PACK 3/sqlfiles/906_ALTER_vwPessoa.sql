...
SELECT
	...
	E.IDEstado as State,
	P.Endereco +
	(CASE IsNull(P.ComplementoNum, '') WHEN '' THEN '' ELSE ' Nº ' + CAST(P.ComplementoNum as varchar) END) +
	(CASE IsNull(P.Complemento, '') WHEN '' THEN '' ELSE ', ' + P.Complemento END) as Address, 
	P.Cidade as City,
	P.CEP as Zip,
	P.Email,
