...
WHERE TABLE_NAME = 'vw_Rep_Acc_Records'
AND COLUMN_NAME IN ('IDPurchase','RecordType', 'IDRecordParent','CheckNumber','CustomerDocument',
		    'CustomerName','CustomerPhone','IDBankCheck','PaymentPlace','IDCashRegMovClosed','IsPreDatado')
