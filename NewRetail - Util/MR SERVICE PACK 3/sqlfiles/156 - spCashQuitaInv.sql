...
CREATE PROCEDURE sp_Cashregister_GetPayments(@Caixa int, @CaixaFechado int, @TipoPag int, @IsFechado bit) AS
/* -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	SUMARIO
...
INSERT INTO #Lancamentos_Caixa
	...
	FROM
		Fin_Lancamento
		INNER JOIN Invoice ON Fin_Lancamento.IDPreSale = Invoice.IDPreSale
