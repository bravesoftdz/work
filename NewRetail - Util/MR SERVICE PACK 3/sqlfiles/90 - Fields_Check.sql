ALTER TABLE Fin_Lancamento ADD CheckNumber          varchar(20) NULL
GO

ALTER TABLE Fin_Lancamento ADD CustomerDocument     varchar(20) NULL
GO

ALTER TABLE Fin_Lancamento ADD CustomerName         varchar(80) NULL
GO

ALTER TABLE Fin_Lancamento ADD CustomerPhone        varchar(20) NULL
GO

ALTER TABLE Fin_Lancamento ADD IDBankCheck          int NULL
GO

ALTER TABLE Fin_Lancamento
       ADD CONSTRAINT FK_Fin_Banco_Fin_Lancamento_IDBankCheck
              FOREIGN KEY (IDBankCheck)
