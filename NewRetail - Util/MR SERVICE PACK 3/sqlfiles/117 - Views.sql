...
SELECT     dbo.PreInventoryMov.IDPreInventoryMov, dbo.PreInventoryMov.DocumentID, dbo.PreInventoryMov.Marked, dbo.Model.Model, dbo.Model.Description, 
                      Comission.Comissionado AS SalesPerson, dbo.PreInventoryMov.MovDate, dbo.PreInventoryMov.Discount, dbo.PreInventoryMov.Qty, 
...
WHERE     (dbo.PreInventoryMov.InventMovTypeID = 1)
