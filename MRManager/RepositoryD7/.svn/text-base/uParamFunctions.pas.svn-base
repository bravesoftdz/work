...
function SetWinConnectionStr(sDB, sServer:String):String;
function SetWinConnectionStrNoNETLIB(sDB, sServer:String):String;
...
begin
  ...
  Result := 'Provider=SQLOLEDB.1;Persist Security Info=True;'+
            'Integrated Security=SSPI;Initial Catalog='+sDB+';Data Source='+sServer+';'
