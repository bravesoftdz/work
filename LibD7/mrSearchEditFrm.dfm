object SearchEditFrm: TSearchEditFrm
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'SearchEditFrm'
  ClientHeight = 290
  ClientWidth = 442
  Color = 13752539
  ...
  object grdSearch: TcxGrid
    ...
    Align = alClient
    TabOrder = 2
    object grdSearchDBTableView: TcxGridDBTableView
