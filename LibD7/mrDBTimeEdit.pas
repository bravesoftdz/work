...
uses
  ...
  Types, Graphics, Messages, cxTimeEdit, cxDBEdit;

type
  TmrDBTimeEdit = class(TcxDBTimeEdit)
  private
...
procedure Register;
begin
  RegisterComponents('MultiTierDataControls', [TmrDBTimeEdit]);
end;

{ TmrDBTimeEdit }

procedure TmrDBTimeEdit.CMBidimodechanged(var Message: TMessage);
begin
  inherited;
...
procedure TmrDBTimeEdit.CMEnabledchanged(var Message: TMessage);
begin
  inherited;
...
procedure TmrDBTimeEdit.CMVisiblechanged(var Message: TMessage);
begin
  inherited;
...
constructor TmrDBTimeEdit.Create(AOwner: TComponent);
begin
...
procedure TmrDBTimeEdit.GetFieldConfig;
begin
...
procedure TmrDBTimeEdit.Notification(AComponent: TComponent;
...
procedure TmrDBTimeEdit.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TmrDBTimeEdit.SetLabelPosition(const Value: TLabelPosition);
var
  P: TPoint;
begin
...
procedure TmrDBTimeEdit.SetLabelSpacing(const Value: Integer);
begin
  FLabelSpacing := Value;
  SetLabelPosition(FLabelPosition);
end;

procedure TmrDBTimeEdit.SetLocked(const Value: Boolean);
begin
  FLocked := Value;
...
procedure TmrDBTimeEdit.SetName(const Value: TComponentName);
begin
...
procedure TmrDBTimeEdit.SetParent(AParent: TWinControl);
begin
...
procedure TmrDBTimeEdit.SetRequired(const Value: Boolean);
begin
  FRequired := Value;
  if Value then
    FRequiredLabel.Parent := Self.Parent
...
procedure TmrDBTimeEdit.SetupInternalLabel;
begin
