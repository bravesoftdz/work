...
type
  TPctColorSpeciesFch = class(TParentButtonFch)
...
procedure TPctColorSpeciesFch.ConfigFchAfterStart(Sender: TObject);
begin
...
procedure TPctColorSpeciesFch.ConfigFchBeforeApplyChanges(Sender: TObject;
  var Apply: Boolean);
begin
  inherited;
...
initialization
  RegisterClass(TPctColorSpeciesFch);
