...
public class FormVerifyReceivingResult extends com.mainretail.util.ParentForm {

	private Vector vetModelVerifyQty = null;

	private ChoiceGroup lista = null;

	public FormVerifyReceivingResult() {
		super();
	...
	public void refreshComponentArray() {
		...
		for (Enumeration en = vetModelVerifyQty.elements(); en
				.hasMoreElements();) {
			ModelVerifyQty mvq = (ModelVerifyQty) en.nextElement();
			
			if (mvq.qty != 0) {
				lista.append(mvq.model.model + '\n' + '\n' + "Qty Purchase: "
						+ String.valueOf(mvq.qty) + '\n' + "Qty Received: "
						+ String.valueOf(mvq.qtyVerified) + '\n' + "Difference: "
						+ String.valueOf(mvq.qty - mvq.qtyVerified) + '\n' + '\n'
						+ '\n', null);
			} else {
				lista.append(mvq.model.barcode + '\n' + '\n'  
						+ String.valueOf(mvq.model.description) + '\n' + "Qty Received: "
						+ String.valueOf(mvq.qtyVerified)  
						+ '\n', null);
			} 
		}
