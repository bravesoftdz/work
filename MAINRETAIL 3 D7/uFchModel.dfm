inherited FchModel: TFchModel
  ...
  object Panel5: TPanel [5]
    ...
    object pgModel: TPageControl
        ...
        object pgModelInfo: TPageControl
          ...
          object tsModelInfo: TTabSheet
            ...
            object Panel6: TPanel
              ...
              object chkDoNotUpdateCatalog: TDBCheckBox
                Left = 10
                Top = 201
                Width = 257
                Height = 17
                Caption = 'Do Not Update Product Information from Catalogs'
                DataField = 'NoUpdateCatalogs'
                DataSource = dsForm
                TabOrder = 9
                ValueChecked = 'True'
                ValueUnchecked = 'False'
      ...
      object tagsPromo: TTabSheet
        Caption = 'Tags, Promos'
        ImageIndex = 14
        object panelTagPromoMain: TPanel
          Left = 0
          Top = 0
          Width = 1022
          Height = 267
          Align = alClient
          Caption = 'panelTagPromoMain'
          TabOrder = 0
          object panelByTag: TPanel
            Left = 366
            Top = 1
            Width = 26
            Height = 265
          ...
          object panelTagPromoSpace: TPanel
            Left = 1
            Top = 1
            Width = 365
            Height = 265
            ...
            object byTagGrid: TcxGrid
              ...
              TabOrder = 1
              OnExit = grdKitModelExit
              object byTagGridTableView: TcxGridDBTableView
                DataController.DataSource = dsByTag
                DataController.Filter.Criteria = {FFFFFFFF0000000000}
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
                ...
                OptionsView.GridLines = glHorizontal
                OptionsView.GroupByBox = False
                object byTagGridTableViewDBColumn1: TcxGridDBColumn
                  Caption = 'Tag'
                  DataBinding.FieldName = 'TagNAme'
                  SortOrder = soAscending
                  Width = 144
                end
                object byTagGridTableViewDBColumn2: TcxGridDBColumn
                  Caption = 'Price Break'
                  DataBinding.FieldName = 'HasQtyPriceBreak'
              ...
              object cxGridLevel2: TcxGridLevel
                GridView = byTagGridTableView
              end
            end
          end
          object panelByPromo: TPanel
            Left = 392
            Top = 1
            Width = 629
            Height = 265
            ...
            object cxGrid2: TcxGrid
              ...
              object cxGridDBTableView1: TcxGridDBTableView
                DataController.DataSource = dsByPromo
                DataController.Filter.Criteria = {FFFFFFFF0000000000}
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
  ...
  inherited quForm: TPowerADOQuery
    ...
    CommandText = 
      'SELECT'#13#10#9'm.IDModel,'#13#10#9'Model,'#13#10#9'GroupID,'#13#10#9'Description,'#13#10#9'Freight' +
      ...
      #13#10'                ,NoUpdateCatalogs'#13#10'FROM'#13#10#9'Model m (NOLOCK) '#13#10#9 +
      'left outer join (select max(p.dateFinalReceiving) LastReceived'#13#10 +
      #9'            ,m.idmodel'#13#10#9#9'  from Pur_Purchase p'#13#10#9#9#9'   join Pur' +
      '_PurchaseItem pci on p.idPurchase = pci.idPurchase'#13#10#9#9#9'   join m' +
      'odel m on m.idModel = pci.idModel'#13#10#9#9'  group by m.idModel'#9'   '#13#10#9 +
      #9'  ) Ld on Ld.idModel = m.idModel'#13#10'WHERE  m.idmodel = :idmodel'#9#13 +
      #10#13#10#13#10#13#10'     '#13#10#13#10#13#10
    Parameters = <
      item
        Name = 'IDModel'#9
        Attributes = [paSigned]
    ...
    object quFormFreightCost: TFloatField
      FieldName = 'FreightCost'
      Origin = 'Model.FreightCost'
      OnChange = quFormFreightCostChange
      DisplayFormat = '#,##0.00'
      currency = True
    end
    object quFormOtherCost: TFloatField
      FieldName = 'OtherCost'
    ...
    object quFormVendorCost: TFloatField
      FieldName = 'VendorCost'
    ...
    object quFormMarkUp: TFloatField
      FieldName = 'MarkUp'
      Origin = 'Model.MarkUp'
      DisplayFormat = '0.00 %'
      EditFormat = '0.00'
    end
    object quFormSellingPrice: TFloatField
      FieldName = 'SellingPrice'
      Origin = 'Model.SellingPrice'
      OnChange = quFormSellingPriceChange
      DisplayFormat = '#,##0.00##'
      currency = True
    end
    ...
    object quFormIDUnidade: TIntegerField
      FieldName = 'IDUnidade'
      Origin = 'Model.IDUnidade'
    end
    object quFormRealMarkUpPercet: TFloatField
    ...
    object quFormSuggRetail: TFloatField
      FieldName = 'SuggRetail'
      Origin = 'Model.IDModel'
      DisplayFormat = '#,##0.00##'
    end
    ...
    object quFormClasseABC: TStringField
      FieldName = 'ClasseABC'
      Origin = 'Model.ClasseABC'
      Size = 1
    end
    object quFormES: TFloatField
      FieldName = 'ES'
      Origin = 'Model.ES'
    end
    object quFormPVD: TFloatField
      FieldName = 'PVD'
      Origin = 'Model.PVD'
    end
    object quFormPP: TFloatField
      FieldName = 'PP'
      Origin = 'Model.PP'
    end
    ...
    object quFormAutomaticRequest: TBooleanField
      ...
      Origin = 'Model.AutomaticRequest'
    end
    object quFormModelType: TStringField
      FieldName = 'ModelType'
      Origin = 'RETAIL.Model.ModelType'
      FixedChar = True
      Size = 1
    end
    object quFormIDColor: TIntegerField
      FieldName = 'IDColor'
      Origin = 'RETAIL.Model.IDColor'
    end
    object quFormIDSize: TIntegerField
      FieldName = 'IDSize'
      Origin = 'RETAIL.Model.IDSize'
    end
    ...
    object quFormTotQtyOnHand: TFloatField
      FieldName = 'TotQtyOnHand'
      DisplayFormat = '0.#####'
    end
    ...
    object quFormNoUpdateCatalogs: TBooleanField
      FieldName = 'NoUpdateCatalogs'
    end
  end
  ...
  object dsByTag: TDataSource
    Left = 115
    Top = 351
  end
  object dsByPromo: TDataSource
    Left = 486
    Top = 401
  end
end
