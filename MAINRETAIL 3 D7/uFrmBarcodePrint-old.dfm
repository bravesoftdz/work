inherited FrmBarcodePrint: TFrmBarcodePrint
  ...
  object cdsBarcodeList: TClientDataSet
    ...
    object cdsBarcodeListLargeImage: TStringField
      FieldName = 'LargeImage'
      Size = 255
    end
    object cdsBarcodeListLargeImage2: TStringField
      FieldName = 'LargeImage2'
      Size = 255
    end
    object cdsBarcodeListManufacturer: TStringField
      FieldName = 'Manufacturer'
      Size = 50
    end
    object cdsBarcodeListVendorNum: TStringField
      FieldName = 'VendorNum'
      Size = 6
    end
    object cdsBarcodeListVendor: TStringField
      FieldName = 'Vendor'
      Size = 50
    end
    object cdsBarcodeListSizeName: TStringField
      FieldName = 'SizeName'
    end
    object cdsBarcodeListColor: TStringField
      FieldName = 'Color'
    end
    object cdsBarcodeListCodColor: TStringField
      FieldName = 'CodColor'
      Size = 10
    end
    object cdsBarcodeListModelToScan: TStringField
      FieldName = 'ModelToScan'
      Size = 32
    end
    object cdsBarcodeListBarcodeToScan: TStringField
      FieldName = 'BarcodeToScan'
      Size = 22
    end
  end
  ...
  object quBarcodeList: TADODataSet
    ...
    CommandText = 
      ...
      'ption, '#13#10#9#9'M.DateLastSellingPrice, '#13#10#9#9'I.StoreAVGPrice,'#13#10#9#9'M.Sel' +
      'lingPrice, '#13#10#9#9'cast(1.0 as Decimal)  QtyOnHand, '#13#10#9#9'BA.Idbarcode' +
      ', '#13#10#9#9'BA.data, '#13#10#9#9'vmc.vendorCode sku,'#13#10#9#9'cast(1 as Decimal ) Nu' +
      'mCopy,'#13#10#9#9'cast( '#39' '#39' as varchar) Report,'#13#10#9#9'M.LargeImage,'#13#10#9#9'M.La' +
      'rgeImage2,'#13#10#9#9'F.Pessoa as Manufacturer,'#13#10#9#9'V.UserCode as VendorN' +
      'um,'#13#10#9#9'V.Pessoa as Vendor,'#13#10'                                S.Si' +
      'zeName,'#13#10'                                C.Color,'#13#10'             ' +
      '                   C.CodColor,'#13#10'                               (' +
      #39'*'#39' + LTRIM(RTRIM(M.Model)) + '#39'*'#39' ) as ModelToScan,'#13#10'           ' +
      '                    ('#39'*'#39' + LTRIM(RTRIM(BA.IdBarcode)) + '#39'*'#39') as ' +
      'BarcodeToScan '#13#10'FROM    Barcode BA (NOLOCK) '#13#10'   LEFT JOIN Inv_B' +
      'arcodePrint B (NOLOCK) ON (BA.IdBarcode = B.IdBarcode) '#13#10'   LEFT' +
      ' JOIN Model M (NOLOCK) ON (M.IDModel = BA.IDModel) '#13#10'   LEFT JOI' +
      'N TabGroup tg (NOLOCK) on m.groupId = tg.idGroup '#13#10'   LEFT JOIN ' +
      'VwModelGroup mg (NOLOCK) on m.IdModel = mg.IdModelGroup and mg.i' +
      'dgroup = tg.idgroup '#13#10'   LEFT JOIN VwModelSubGroup msg (NOLOCK) ' +
      'on mg.IdModelgroup = msg.IdModelGroup and mg.IdGroup = msg.IdGro' +
      'up '#13#10'   LEFT OUTER JOIN InvSize S (NOLOCK) ON (S.IDSize = M.IDSi' +
      'ze)'#13#10'   LEFT OUTER JOIN InvColor C (NOLOCK) ON (C.IDColor = M.ID' +
      'Color)'#13#10'   LEFT JOIN Inv_ModelVendor IMV (NOLOCK) ON (M.IDModel ' +
      '= IMV.IDModel) '#13#10'   LEFT JOIN VendorModelCode vmc (NOLOCK) on M.' +
      'idModel = vmc.idModel  '#13#10'   LEFT JOIN Inventory I ON (M.Idmodel ' +
      '= I.ModelID) '#13#10'   LEFT JOIN Pessoa P (NOLOCK) ON vmc.IdPessoa = ' +
      'P.IDPessoa'#13#10'   LEFT OUTER JOIN Inv_ModelVendor MV (NOLOCK) ON (M' +
      '.IDModel = MV.IDModel AND MV.VendorOrder = 1)'#13#10'   LEFT OUTER JOI' +
      'N Pessoa F (NOLOCK) ON (M.IDFabricante = F.IDPessoa)'#13#10'   LEFT OU' +
      'TER JOIN Pessoa V (NOLOCK) ON (MV.IDPessoa = V.IDPessoa)'#13#10'WHERE ' +
      'm.IdModel = -1 and m.desativado = 0'
    Parameters = <>
    Left = 253
    Top = 190
    ...
    object quBarcodeListLargeImage: TStringField
      FieldName = 'LargeImage'
      Size = 255
    end
    object quBarcodeListLargeImage2: TStringField
      FieldName = 'LargeImage2'
      Size = 255
    end
    object quBarcodeListManufacturer: TStringField
      FieldName = 'Manufacturer'
      Size = 50
    end
    object quBarcodeListVendorNum: TStringField
      FieldName = 'VendorNum'
      Size = 6
    end
    object quBarcodeListVendor: TStringField
      FieldName = 'Vendor'
      Size = 50
    end
    object quBarcodeListSizeName: TStringField
      FieldName = 'SizeName'
    end
    object quBarcodeListColor: TStringField
      FieldName = 'Color'
    end
    object quBarcodeListCodColor: TStringField
      FieldName = 'CodColor'
      Size = 10
    end
    object quBarcodeListModelToScan: TStringField
      FieldName = 'ModelToScan'
      Size = 32
    end
    object quBarcodeListBarcodeToScan: TStringField
      FieldName = 'BarcodeToScan'
      Size = 22
    end
  end
