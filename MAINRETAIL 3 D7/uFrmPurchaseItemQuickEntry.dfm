inherited FrmPurchaseItemQuickEntry: TFrmPurchaseItemQuickEntry
  ...
  object qryModel: TADODataSet
    Connection = DM.ADODBConnect
    CommandText = 
      'SELECT'#13#10#9'M.IDModel,'#13#10#9'M.Model,'#13#10#9'M.Description,'#13#10#9'M.GroupID,'#13#10#9'M' +
      '.SellingPrice,'#13#10#9'M.FinalCost,'#13#10#9'M.SuggRetail,'#13#10#9'IsNull(M.CaseQty' +
      ', 0) CaseQty,'#13#10#9'F.Pessoa as Manufacturer'#13#10'FROM'#13#10#9'Model M'#13#10#9'LEFT ' +
      'OUTER JOIN Pessoa F ON (M.IDFabricante = F.IDPessoa)'#13#10#9'LEFT OUTE' +
      'R JOIN Barcode B ON (M.IDModel = B.IDModel)'#13#10#9'LEFT OUTER JOIN Ve' +
      'ndorModelCode VMC ON (M.IDModel = VMC.IDModel AND VMC.IDPessoa =' +
      ' :IDVendor)'
    Parameters = <
      item
        Name = 'IDVendor'
