...
Issue   : Replace old quick entry to new ModelAdd
Solution: keep name of reference but change class called.
Version : (289 - 286)
-----------------------------------------------------------------------------------------------------
*)
...
uses
  ...
  ADODB, DB, Buttons, DBCtrls, ufrmModelAdd,{amfsouza 03.18.2011 uFrmModelQuickEntry,} uFrmBarcodeSearch,
  mrBarCodeEdit;
...
type
  ...
  private
    ...
    FIDPurchase: Integer;
    FIDVendor: Integer;
    FFrmModelQuickEntry: TFrmModelAdd;// amfsouza 03.18.2011 TFrmModelQuickEntry;
...
//amfsouza 03.18.2011 -  FFrmModelQuickEntry := TFrmModelAddQuickEntry.Create(Self);
  ...
  btNewItem.Enabled            := (DM.fSystem.VersionType <> QuotedStr(SYSTEM_CLIENT_TYPE));
