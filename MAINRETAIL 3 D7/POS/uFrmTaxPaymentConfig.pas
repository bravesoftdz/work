...
procedure TFrmTaxPaymentConfig.btnResultClick(Sender: TObject);
var
  sResult : String;
begin
  inherited;
  if PageControl1.ActivePage = tsTax then
  begin
    DM.EFiscal1.RetornoAliquotas(sResult);
    ShowMessage('Aliquotas : ' + sResult);
  end
  else
  begin
    DM.EFiscal1.VerificaFormasPagamento(sResult);
    ShowMessage('Formas Pgto : ' + sResult);
  end;
end;
