inherited DM: TDM
  ...
  inherited ADODBConnect: TADOConnection
    ConnectionString = 
      ...
      'er ID=sa;Initial Catalog=CameliDB;Data Source=Desenv000;Use Proc' +
  ...
  object quPreSaleNegativeItems: TADODataSet
    Connection = ADODBConnect
    CursorType = ctStatic
    CommandText = 
      'SELECT'#13#10#9'PIM.ModelID,'#13#10#9'SUM(PIM.Qty) as Qty,'#13#10#9'IV.QtyOnHand'#13#10'FRO' +
      'M'#13#10#9'PreInventoryMov PIM (NOLOCK)'#13#10#9'JOIN Invoice I (NOLOCK) ON (I' +
      '.IDPreSale = PIM.DocumentID)'#13#10#9'JOIN Inventory IV (NOLOCK) ON (IV' +
      '.ModelID = PIM.ModelID AND IV.StoreID = :IDStore)'#13#10'WHERE'#13#10#9'I.Sal' +
      'eCode = :SaleCode'#13#10#9'AND'#13#10#9'PIM.InventMovTypeID = 1'#13#10'GROUP BY'#13#10#9'PI' +
      'M.ModelID,'#13#10#9'IV.QtyOnHand'#13#10'HAVING'#13#10#9'SUM(PIM.Qty) > IV.QtyOnHand'#13 +
      #10#13#10#13#10
    Parameters = <
      item
        Name = 'IDStore'
