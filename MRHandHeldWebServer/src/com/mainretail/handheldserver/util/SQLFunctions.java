...
public class SQLFunctions {
	...
	public int getNextCode(String tablefield) throws SQLException {		
		...
		try {
			...
			ConnectionFunctions.getInstance().closeConnection(null, spNextCode, con);	
		}
	...
	public String hashTableToSQLProcedure(String procedureName, Hashtable ht) throws SQLException{
		...
		System.out.println("Codigo de execução da procedure:");
	...
	private String integerToSQLString(Integer i){
		return Util.replaceAll(i.toString(),",","");  
	}
	
	private String doubleToSQLString(Double d){
		return Util.replaceAll(NumberFormat.getInstance(Locale.US).format(d),",","");
	}
