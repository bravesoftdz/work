...
uses
  ...
  Dialogs, uParentAllFrm, siComp, siLangRT, StdCtrls, gbCobranca, DB, ADODB;

type
  TFrmPrintBoleto = class(TParentAllFrm)
    gbTitulo: TgbTitulo;
...
function TFrmPrintBoleto.ReturnNumber(AText: String): String;
var
  i : Integer;
begin
  i := 1;
...
begin
  ...
  if quPagamentoSaleCode.AsString <> '' then
    ...
    quPagamentoNossoNumeroFinal.AsString := Copy(quPagamentoIDLancamento.AsString, 1, 8);
