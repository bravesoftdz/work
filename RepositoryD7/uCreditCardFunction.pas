...
type
  // Antonio 09/18/2015 - added to deal with Declined transactions
  TTransactionReturn = (ttrSuccessfull, ttrNotSuccessfull, ttrError, ttrException, ttrDeclined);

  //amfsouza 01.12.2012
  TTransactionErrorLevel = (ttelSoft, ttelSoftRetry, ttelSoftNoRetry, ttelHard);
