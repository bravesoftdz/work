...
uses
  ...
  EanKod, EanSpecs, Types, SysUtils, Classes, QForms, QDialogs,
  QStdCtrls, QButtons, QControls, QComCtrls, QGraphics, QExtCtrls, Dialogs,
  Controls, StdCtrls, Buttons, ComCtrls, Graphics, ExtCtrls;
