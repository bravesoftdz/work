...
procedure TBarcodeReader.SetOptions(Value:TpsBarcodeReaderOptions);
var ac:Boolean;
begin
     ac:=Active;
     InternalClose;
...
procedure TBarcodeReader.SendToPort(s:String);
begin
...
procedure TBarcodeReader.ActivateScale;
begin
     SendToPort(FScaleString);
end;


function TBarcodeReader.GetHandle: THandle;
begin
...
procedure TBarcodeReader.SetHandle(const Value: THandle);
begin
        {}
end;
