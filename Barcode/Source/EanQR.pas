...
uses
     ...
     {$else}
        Graphics, Messages, Controls, Printers, Dialogs, Windows,
        quickrpt, Qrctrls,
     {$endif}
...
type
  TQrCustomEan = class(TQrPrintable)
     ...
     protected
            ...
            Procedure   SetAutoSize(Value:Boolean);  {$ifdef PSOFT_D6} override; {$endif}
...
function TQrCustomEan.QrCalcRect(OfsX,OfsY:Integer):TRect;
begin
...
begin
     if ParentReport.FinalPass and Enabled then begin
        ...
        PaintBarCode(QRPrinter.Canvas,R,FEan);
