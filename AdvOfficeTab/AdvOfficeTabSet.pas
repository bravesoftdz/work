...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Caption := TrimText(Caption, r, False, nil, Canvas, font, stringformat, True, Direction);
      end;
...
begin
  ...
  begin
    Tab.FChildForm.OnCloseQuery(Tab.FChildForm, Allow);
  end;
  ...
  begin
    ...
    begin
      Tab.FChildForm.OnClose(Tab.FChildForm,ca);
    end;
