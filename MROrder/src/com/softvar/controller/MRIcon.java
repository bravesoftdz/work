...
public final class MRIcon {
  ...
  public static JButton createGifButton(String text, String icon) {
	    ImageIcon iconNormal = readImageIcon(icon + ".gif");
  ...
  protected static ImageIcon readImageIcon(String filename) {
	  URL url = MRIcon.class.getResource("/com/softvar/res/"+filename);
	  if (url == null)
		  return null;
	  else
