object DMPDV: TDMPDV
  ...
  object quCustomer: TADODataSet
    ...
    CommandText = 
      ...
      'CPF END) as CPF,'#13#10#9'P.InscEstadual,'#13#10#9'P.Bairro'#13#10'FROM '#9#13#10#9'Pessoa P' +
      ' (NOLOCK)'#13#10#9'JOIN TipoPessoa TP ON (TP.IDTipoPessoa = P.IDTipoPes' +
      'soa)'#13#10'WHERE '#9#13#10#9'TP.Path like '#39'.001%'#39#13#10'ORDER BY '#13#10#9'P.Pessoa'
    Parameters = <>
    Left = 32
    Top = 256
  end
  ...
  object quBarcodeSearch: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT'#13#10#9'B.IDBarcode,'#13#10#9'B.IDModel,'#13#10#9'M.Model'#13#10'FROM'#13#10#9'Barcode B'#13#10 +
      #9'JOIN Model M ON (M.IDModel = B.IDModel)'#13#10'WHERE'#13#10#9'M.Desativado =' +
      ' 0'#13#10#9'AND'#13#10#9'M.Hidden = 0'#13#10#9'AND'#13#10#9'M.ModelType IN ('#39'S'#39', '#39'R'#39', '#39'V'#39', '#39 +
      'C'#39','#39'K'#39', '#39'G'#39' )'#13#10'ORDER BY'#13#10#9'B.IDBarcode'
    Parameters = <>
    Left = 436
    Top = 256
  end
