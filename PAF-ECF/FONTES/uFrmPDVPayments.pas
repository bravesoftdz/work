...
type
  ...
  public
    { Public declarations }
    function Start(var MP: TMeioPagamento; var ATEFCallInfo : TTEFCallInfo): Boolean;
  end;


implementation

uses uDMGlobal, uDMPDV, uSystemConst, uDM, uTEFConsts;

{$R *.dfm}

function TFrmPDVPayments.Start(var MP: TMeioPagamento; var ATEFCallInfo : TTEFCallInfo): Boolean;
begin
  bResult                 := False;
  bPostDate               := False;
  MeioPagamento           := nil;
    ...
    case lvwPayType.Tag of
      ...
      1:
        begin
          ...
          lvwPayType.Items.Clear;
          lvwPayType.Items.BeginUpdate;
          pnlPayOption.Visible := (TP.Tipo in [PAYMENT_TYPE_CARD, PAYMENT_TYPE_DEBIT, PAYMENT_TYPE_CHECK]);
          ...
          begin
            if TTipoPagamento(lvwPayType.Selected.Data).Count = 1 then
              begin
                ...
                bPostDate :=
                  (MeioPagamento.TipoPagamento.Tipo in [PAYMENT_TYPE_CARD, PAYMENT_TYPE_DEBIT, PAYMENT_TYPE_CHECK])
...
begin
  ...
  begin
     pnlPayOption.Visible := ((ATipoPagamento.Tipo in [PAYMENT_TYPE_CARD, PAYMENT_TYPE_DEBIT, PAYMENT_TYPE_CHECK]) and
