...
GO
CREATE   PROCEDURE [dbo].[sp_Inv_CalcBalance]
AS
/* -----------------------------------------------------------------------------------------------------------
	SUMARIO
	...
	5 Aug	2009		Rodrigo Costa		Atualizar a data de movimentacao diaria na tabela
...
BEGIN
	...
	UPDATE DailyMaintenanceReport SET LastMessage = 'Started', [Date] = @MovDate 
	WHERE Maintenance = 'CalcInventoryBalance'
