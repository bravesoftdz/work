object FrmImprimirRAEC: TFrmImprimirRAEC
  Left = 240
  Top = 170
  ...
  object pnlCentro: TPanel
    ...
    object grdGarantias: TcxGrid
      ...
      object grdGarantiasTableView: TcxGridDBTableView
        ...
        OnFocusedRecordChanged = grdGarantiasTableViewFocusedRecordChanged
  ...
  object cdsForm: TClientDataSet
    ...
    object cdsFormIDModel: TIntegerField
      FieldName = 'IDModel'
      OnChange = cdsFormIDModelChange
    end
    object cdsFormChecado: TBooleanField
      FieldName = 'Checado'
    end
    object cdsFormIDPreSale: TIntegerField
      FieldName = 'IDPreSale'
    end
  end
  ...
  object dspForm: TDataSetProvider
    DataSet = quForm
    Options = [poIncFieldProps]
    Left = 196
    Top = 184
  end
  object quForm: TADODataSet
    Connection = FrmPrincipal.Connection
    CommandText = 
      'SELECT'#13#10#9'I.IDInvoice,'#13#10#9'I.IDPreSale,'#13#10#9'I.IDPreSaleParent,'#13#10#9'I.In' +
      'voiceCode,'#13#10#9'I.SaleCode,'#13#10#9'dbo.fn_Sys_RemoveTime(IM.MovDate) Mov' +
      'Date,'#13#10#9'I.IDStore as StoreID,'#13#10#9'IM.SequencyNum,'#13#10#9'IM.SalePrice,'#13 +
      #10#9'IM.Qty,'#13#10#9'IM.IDPreInvMovExchange,'#13#10#9'M.IDModel IDModelGarantia,' +
      #13#10#9'M.IDModel,'#13#10#9'M.Model,'#13#10#9'M.Description,'#13#10#9'F.Pessoa Fabricante,' +
      #13#10#9'SM.SerialNumber,'#13#10#9'cast('#39#39' as varchar) NotaFiscalProduto,'#13#10#9'c' +
      'ast(0.00 as money) ValorProduto,'#13#10#9'cast('#39#39' as varchar(6)) Garant' +
      'iaTipo,'#13#10#9'cast(12 as int) GarantiaMeses,'#13#10#9'cast(12 as int) Garan' +
      'tiaFabrica,'#13#10#9'cast('#39#39' as varchar(50)) DescProduto,'#13#10#9'cast('#39#39' as ' +
      'varchar) Documento,'#13#10#9'cast('#39#39' as varchar) FormaPagamento,'#13#10#9'cast' +
      '(null as datetime) DataEnvio,'#13#10#9'cast(0 as bit) Checado,'#13#10#9'dbo.fn' +
      '_Sys_RemoveTime(IM.MovDate) InicioVigencia,'#13#10#9'dbo.fn_Sys_RemoveT' +
      'ime(IM.MovDate) TerminoVigencia,'#13#10#9'L.[Name] Loja,'#13#10#9'C.Pessoa Nom' +
      'e,'#13#10#9'C.Endereco,'#13#10#9'C.Bairro,'#13#10#9'C.CEP,'#13#10#9'C.Cidade,'#13#10#9'C.IDEstado U' +
      'F,'#13#10#9'(C.Cidade + '#39' - '#39' + C.IDEstado + '#39' - '#39' + C.CEP) CidadeUFCEP' +
      ','#13#10#9'dbo.fn_Sys_RemoveTime(C.Nascimento) DataNascimento,'#13#10#9'C.CPF,' +
      #13#10#9'C.Identidade,'#13#10#9'C.OrgaoEmissor IdentidadeOrgaoEmissor,'#13#10#9'dbo.' +
      'fn_Sys_RemoveTime(C.DataExpedicao) IdentidadeDataExpedicao,'#13#10#9'(c' +
      'ast(dbo.fn_Sys_RemoveTime(C.DataExpedicao) as varchar) + '#39' - '#39' +' +
      ' C.OrgaoEmissor) IdentidadeExpedicaoOrgao,'#13#10#9'('#39'('#39' + C.PhoneAreaC' +
      'ode + '#39')'#39' + C.Telefone) Telefone,'#13#10#9'('#39'('#39' + C.CellAreaCode + '#39')'#39' ' +
      '+ C.Cellular) Celular'#13#10'FROM'#13#10#9'InventoryMov IM'#13#10#9'JOIN Model M ON ' +
      '(M.IDModel = IM.ModelID)'#13#10#9'JOIN Invoice I ON (I.IDInvoice = IM.D' +
      'ocumentID AND IM.InventMovTypeID = 1)'#13#10#9'JOIN Pessoa C ON (I.IDCu' +
      'stomer = C.IDPessoa)'#13#10#9'JOIN Store L ON (I.IDStore = L.IDStore)'#13#10 +
      #9'LEFT JOIN Pessoa F ON (M.IDFabricante = F.IDPessoa)'#13#10#9'LEFT JOIN' +
      ' SerialMov SM ON (IM.IDInventoryMov = SM.InventoryMovID)'#13#10'WHERE'#13 +
      #10#9'GroupID = 100'#13#10#9'AND dbo.fn_Sys_RemoveTime(IM.MovDate) >= :Data' +
      'Inicial'#13#10#9'AND dbo.fn_Sys_RemoveTime(IM.MovDate) <= :DataFinal'#13#10'O' +
    ...
    Left = 196
    Top = 132
    object quFormMovDate: TDateTimeField
      FieldName = 'MovDate'
    end
    object quFormStoreID: TIntegerField
      FieldName = 'StoreID'
    end
    object quFormSequencyNum: TIntegerField
      FieldName = 'SequencyNum'
    end
    object quFormSalePrice: TBCDField
      FieldName = 'SalePrice'
      DisplayFormat = 'R$ #,##0.00'
      Precision = 19
    end
    ...
    object quFormIDPreInvMovExchange: TIntegerField
      FieldName = 'IDPreInvMovExchange'
    end
    ...
    object quFormFabricante: TStringField
      FieldName = 'Fabricante'
      Size = 50
    end
    ...
    object quFormValorProduto: TBCDField
      FieldName = 'ValorProduto'
      DisplayFormat = 'R$ #,##0.00'
      Precision = 19
    end
    object quFormGarantiaTipo: TStringField
      FieldName = 'GarantiaTipo'
      Size = 6
    end
    object quFormGarantiaMeses: TIntegerField
      FieldName = 'GarantiaMeses'
    end
    object quFormGarantiaFabrica: TIntegerField
      FieldName = 'GarantiaFabrica'
    end
    object quFormDescProduto: TStringField
      FieldName = 'DescProduto'
      Size = 50
    end
    object quFormDocumento: TStringField
      FieldName = 'Documento'
      Size = 30
    end
    object quFormFormaPagamento: TStringField
      FieldName = 'FormaPagamento'
      Size = 30
    end
    object quFormInicioVigencia: TDateTimeField
      FieldName = 'InicioVigencia'
    end
    object quFormTerminoVigencia: TDateTimeField
      FieldName = 'TerminoVigencia'
    end
    object quFormLoja: TStringField
      FieldName = 'Loja'
      Size = 30
    end
    object quFormNome: TStringField
      FieldName = 'Nome'
      Size = 50
    end
    ...
    object quFormUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 3
    end
    object quFormCidadeUFCEP: TStringField
      FieldName = 'CidadeUFCEP'
      Size = 61
    end
    object quFormDataNascimento: TDateTimeField
      FieldName = 'DataNascimento'
    end
    ...
    object quFormIdentidadeOrgaoEmissor: TStringField
      FieldName = 'IdentidadeOrgaoEmissor'
      Size = 50
    end
    object quFormIdentidadeDataExpedicao: TDateTimeField
      FieldName = 'IdentidadeDataExpedicao'
    end
    object quFormIdentidadeExpedicaoOrgao: TStringField
      FieldName = 'IdentidadeExpedicaoOrgao'
      Size = 83
    end
    ...
    object quFormCelular: TStringField
      FieldName = 'Celular'
      Size = 23
    end
    object quFormSaleCode: TStringField
      FieldName = 'SaleCode'
    end
    object quFormInvoiceCode: TStringField
      FieldName = 'InvoiceCode'
    end
    object quFormIDInvoice: TIntegerField
      FieldName = 'IDInvoice'
    end
    object quFormIDPreSaleParent: TIntegerField
      FieldName = 'IDPreSaleParent'
    end
    object quFormNotaFiscalProduto: TStringField
      FieldName = 'NotaFiscalProduto'
      Size = 30
    end
    object quFormDataEnvio: TDateTimeField
      FieldName = 'DataEnvio'
    end
    object quFormIDModelGarantia: TIntegerField
      FieldName = 'IDModelGarantia'
    end
    object quFormIDModel: TIntegerField
      FieldName = 'IDModel'
    end
    object quFormChecado: TBooleanField
      FieldName = 'Checado'
    end
  ...
  object quProduct: TADOQuery
    ...
    SQL.Strings = (
      ...
      'FROM'
      #9'Model M'
      #9'JOIN InventoryMov IM ON (M.IDModel = IM.ModelID)')
    Left = 380
    Top = 133
    ...
    object quProductSalePrice: TBCDField
      FieldName = 'SalePrice'
      Precision = 19
    end
  end
  ...
  object cdsProduct: TClientDataSet
    ...
    Left = 493
    Top = 133
    object cdsProductIDModel: TIntegerField
      FieldName = 'IDModel'
    end
    object cdsProductDescription: TStringField
      FieldName = 'Description'
      Size = 50
    end
    object cdsProductSalePrice: TBCDField
      FieldName = 'SalePrice'
      Precision = 19
    end
  end
